...
public class TimestampAsyncRecordEmitter<T, KPH> extends RecordEmitter<T, KPH> {
    public TimestampAsyncRecordEmitter(ProcessingTimeService processingTimeProvider,
    ...
    public void putRecord(T record, KafkaTopicPartitionState<KPH> partitionState, long offset) throws Exception {
        emitRecord(record, partitionState, offset);
    }
}
